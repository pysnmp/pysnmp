#
# PySNMP MIB module SNMP-COMMUNITY-MIB (https://pysnmp.github.io/pysmi/)
...
if mibBuilder.loadTexts:
    snmpCommunityMIB.setRevisionsDescriptions(
        (
...
if mibBuilder.loadTexts:
    snmpCommunityMIB.setLastUpdated("2003-08-06 00:00")
if mibBuilder.loadTexts:
