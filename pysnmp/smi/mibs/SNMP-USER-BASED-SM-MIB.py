...
if mibBuilder.loadTexts:
    snmpUsmMIB.setRevisionsDescriptions(
        (
            "Changes in this revision: - Updated references and contact info. - Clarification to usmUserCloneFrom DESCRIPTION clause - Fixed 'command responder' into 'command generator' in last para of DESCRIPTION clause of usmUserTable. This revision published as RFC3414. ",
            "Clarifications, published as RFC2574",
            "Initial version, published as RFC2274",
        )
    )
if mibBuilder.loadTexts:
    snmpUsmMIB.setLastUpdated("2002-10-16 00:00")
if mibBuilder.loadTexts:
...
usmUserEngineID = MibTableColumn(
    (1, 3, 6, 1, 6, 3, 15, 1, 2, 2, 1, 1), SnmpEngineID()
).setMaxAccess("notaccessible")
if mibBuilder.loadTexts:
