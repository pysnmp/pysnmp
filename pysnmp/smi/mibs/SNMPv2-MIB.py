#
# PySNMP MIB module SNMPv2-MIB (https://pysnmp.github.io/pysmi/)
...
DisplayString, TextualConvention, TestAndIncr, TimeStamp = mibBuilder.importSymbols(
    "SNMPv2-TC", "DisplayString", "TextualConvention", "TestAndIncr", "TimeStamp"
)
...
if mibBuilder.loadTexts:
    snmpMIB.setRevisionsDescriptions(
        (
...
if mibBuilder.loadTexts:
    snmpMIB.setLastUpdated("2002-10-16 00:00")
if mibBuilder.loadTexts:
