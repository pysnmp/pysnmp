...
snmpFrameworkMIBCompliance = snmpFrameworkMIBCompliance.setStatus("current")
if mibBuilder.loadTexts:
...
snmpEngineGroup = snmpEngineGroup.setStatus("current")
if mibBuilder.loadTexts:
